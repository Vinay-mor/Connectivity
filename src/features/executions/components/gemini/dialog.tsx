...
const formSchema = z.object({
    ...
    credentialId: z.string().min(1, "Credetial is required"),
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        The prompt to send to the AI.Use {"{{variables}}"} for the simple values or {"{{json variable}}"} to stringify objects
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
