...
import { useCreateCredentials, useRemoveCredential, useSuspenseCredentials } from "../hooks/use-credentials"
...
export const CredentialsHeader = ({ disabled }: { disabled?: boolean }) => {
    const createCrednential = useCreateCredentials();
    ...
    return (
        <EntityHeader
            ...
            disabled={disabled}
            isCreating={createCrednential.isPending}
        />
    )
}
